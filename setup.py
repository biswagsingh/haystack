...
setup(
    ...
    author_email="biswagourav.singh@gmail.com",
    ...
    license="Apache",
    url="https://github.com/biswasingh/haystack",
    download_url="https://github.com/biswasingh/haystack/archive/0.4.0.tar.gz",
